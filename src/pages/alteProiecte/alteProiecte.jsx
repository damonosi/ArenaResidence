    ...
    <>
          ...
          <div className="member member-left">
            ...
            <div className="member-info">
              ...
              <div className="member-content">
                <p>
                  Cladirea este dispusa pe structura de inaltime P+6.
                  Constructia este pe cadre din caramida porotherm: 30cm
                  exterior /25cm intre apartamente/11cm comparimentare.
                  Termosistem vata bazaltica 10cm cu tencuiala decorativa tip
                  Baumit.
                </p>
                ...
                <p>
                  -Tamplaria exterioara este din PVC tristrat (culoare wengue)
                  cu geam termopan. Glafuri granit interior si exterior.{" "}
                </p>
                <Layer
            ...
            <div className="member-info2">
              ...
              <div className="member-content">
                <p>
                  ...
                  prin eleganta si rafinament iar clasicul se impleteste
                  armonios cu modernul.
                </p>
                <p>
            ...
            <div className="member-info3">
              ...
              <div className="member-content">
                ...
                <p>
                  ...
                  care se adauga atentia obsesiva acordata celor mai mici
                  detalii, fac ca imobilul sa capteze esenta locuintei moderne,
                  elegante si comfortabile.
                </p>
                ...
                <p>
                  ...
                  './../../components/AlteProiecte/imageGallery'; ci 600m de
                  Rezervatia Naturala a lacului Bacau II.
                </p>
      ...
      <ImageModal open={isOpen} onClose={() => setIsOpen(false)}>
        <div className="gal-cont">
          <h1>Galerie Strada 1 mai 60</h1> <Galerie />
        </div>
      </ImageModal>
      ...
      <ImageModal open={isOpen3} onClose={() => setIsOpen3(false)}>
        <div className="gal-cont">
          <h1>Gemenii din Stefan Cel Mare</h1> <Galerie />
        </div>
      </ImageModal>
    </>
  );
